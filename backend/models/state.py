...
class ConversationState(BaseModel):
    ...
    task_history: List[Dict[str, Any]] = Field(
        ...
        description="History of all tasks in this conversation"
    )
...
class AgentMessage(BaseModel):
    ...
    message_type: str = Field(
        description="Type of message: request, response, notification, error"
    )
    ...
    context_id: Optional[str] = Field(
        None,
        description="Associated conversation context"
    )
...
class ToolCall(BaseModel):
    ...
    error: Optional[str] = Field(
        None,
        description="Error if tool call failed"
    )
...
class SystemMetrics(BaseModel):
    ...
    connected_agents: List[str] = Field(default_factory=list, description="List of connected agents")
